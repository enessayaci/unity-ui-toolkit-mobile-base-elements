...
public class JoystickController
{
    ...
    {
        VisualTreeAsset joystickAsset = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/UI/Components/Joystick/Joystick.uxml"); // To find the joystick uxml, make sure you place it in the right place or rearrange the path according to your own usage.
        StyleSheet joystickUSS = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/UI/Components/Joystick/Joystick.uss"); // To find the joystick uss, make sure you place it in the right place or rearrange the path according to your own usage.
        VisualElement joystickUI = joystickAsset.Instantiate();
        ...
        UIManager.root.styleSheets.Add(joystickUSS); // add joystick uss file to root, it is needed to apply joystick styles
        UIManager.root.Insert(0, joystickTouchArea); // add joystick node to root
